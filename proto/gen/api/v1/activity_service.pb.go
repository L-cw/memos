...
const file_api_v1_activity_service_proto_rawDesc = "" +
	"\n" +
	"\x1dapi/v1/activity_service.proto\x12\fmemos.api.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xde\x01\n" +
	"\bActivity\x12\x12\n" +
	...
	"\x0eversion_update\x18\x02 \x01(\v2*.memos.api.v1.ActivityVersionUpdatePayloadR\rversionUpdate\"S\n" +
	"\x1aActivityMemoCommentPayload\x12\x12\n" +
	"\x04memo\x18\x01 \x01(\tR\x04memo\x12!\n" +
	"\frelated_memo\x18\x02 \x01(\tR\vrelatedMemo\"8\n" +
