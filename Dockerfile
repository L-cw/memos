# Build frontend dist.
FROM registry.cn-hangzhou.aliyuncs.com/goodlcw1-prod/node:20-alpine AS frontend
...
FROM registry.cn-hangzhou.aliyuncs.com/goodlcw1-prod/golang:1.23-alpine AS backend
